...
//	unsigned char blue = B>>3;
	return (((Reverse5Bit[gamma5bit[R]]) | ((Reverse5Bit[gamma5bit[G]]) << 5)
				| ((Reverse5Bit[gamma5bit[B]]) << 10)));
}

uint16_t setColor2(unsigned char R,unsigned char G,unsigned char B){
	unsigned char red = R>>3;
	unsigned char green = G>>3;
	unsigned char blue = B>>3;
...
//    	setPixel(1,0,setColor(0xFF,0xA5,0x00));
//    	setPixel(0,1,setColor(0xFF,0x00,0x00));
//    	setPixel(1,1,setColor(0xFF,0xFF,0x00));
    	...
    	setPixel(1,0,setColor2(0x00,0x00,0x80));
    	setPixel(1,1,setColor2(0x00,0x00,0xFF));
    	setPixel(1,2,setColor2(0x00,0x80,0x00));
    	setPixel(1,3,setColor2(0x00,0x80,0x80));
    	setPixel(1,4,setColor2(0x00,0xFF,0x00));
    	setPixel(1,5,setColor2(0x00,0xFF,0xFF));
    	setPixel(1,6,setColor2(0x80,0x00,0x00));
    	setPixel(1,7,setColor2(0x80,0x00,0x80));
    	setPixel(1,8,setColor2(0x80,0x80,0x00));
    	setPixel(1,9,setColor2(0x80,0x80,0x80));
    	setPixel(1,10,setColor2(0xC0,0xC0,0xC0));
    	setPixel(1,11,setColor2(0xFF,0x00,0x00));
    	setPixel(1,12,setColor2(0xFF,0x00,0xFF));
    	setPixel(1,13,setColor2(0xFF,0xFF,0x00));
    	setPixel(1,14,setColor2(0xFF,0xFF,0xFF));
    	setPixel(1,15,setColor2(0x00,0x00,0x00));
    	setPixel(1,16,setColor2(0xFF,0xA5,0x00));

    	test = gamma5bit[128];
    	test = gamma5bit[208];
    	test = Reverse5Bit[gamma5bit[208]];
    	test = Reverse5Bit[gamma5bit[128]];
    }
}
